...
class _GradientPageState extends State<GradientPage> {
  String imageURL =
      'https://images.vexels.com/media/users/3/140384/isolated/preview/fa2513b856a0c96691ae3c5c39629f31-girl-profile-avatar-1.png';
  String text = 'Flirty';
  int counter = 0;
  Color backgroundColor = Colors.transparent;
  Color rotateButtoncolor = const Color(0xffE277A6);
  Color textcolor = const Color(0xffF3A59B);
  double startAnglemood = 234;
  ...
  void imageRotateright() {
    if (text == 'Flirty') {
      ...
      text = 'Funny';
      backgroundColor = const Color(0xffF6A6FF);
      ...
      text = 'Banter';
      backgroundColor = const Color(0xffF8ED99);
    ...
    return Container(
      decoration: const BoxDecoration(
        gradient: LinearGradient(
          colors: [Color(0xffF8ED99), Color(0xffF6A6FF)],
